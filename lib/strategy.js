...
JwtStrategy.prototype.authenticate = function (req, options) {
    ...
    if (req.headers[AUTH_HEADER]) {
        ...
        if (!auth_params) {
            ...
            //return self.error(new Error("Invalid authorization header"));
        }
    ...
    if (error && self._passReqToCallback) {
        return self._verify(req, error, null, verified);
    } else if (error) {
        return self._verify(error, null, verified);
    }
